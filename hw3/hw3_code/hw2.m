...
joint_angles = readmatrix("q3_4_d2.txt");
...
for ii = 1:length(joint_angles)
    gab = calcFK(twists, joint_angles(ii,:), g_init);
...
% c = xyz_tip(6000,:);
% v= cross(a-b,c-b)*50;
plot3(xyz_tip(:,1), xyz_tip(:,2), xyz_tip(:,3));
hold on;
%plot3([b(1), b(1) - v(1)],[b(2), b(2) - v(2)],[b(3), b(3) - v(3)],'-or')
